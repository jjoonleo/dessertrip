...
export const enMessages = {
  ...
  "nav.activities.description":
    "Browse activities, create new ones, and manage generated groups.",
  ...
  "dashboard.shell.page": "Page",
  "dashboard.shell.navigationEnabled": "Sidebar navigation enabled",
  ...
  "overview.stats.activities.title": "Regular activities",
  ...
  "activities.title": "Regular activities",
  "activities.description":
    "Browse saved Saturday activities, inspect generated groups, and jump into the create or edit form from here.",
  "activities.stats.saved.title": "Saved activities",
  "activities.stats.saved.description": "All persisted Saturday records",
  ...
  "activities.collapse.hint": "Click to view groups and actions",
  ...
  "builder.description":
    "Create or edit a Saturday activity by choosing a date and location, selecting members, generating groups, and then adjusting them manually.",
  ...
  "builder.form.title.add": "New regular activity",
  "builder.form.title.edit": "Edit regular activity",
  ...
  "builder.field.date": "Saturday date",
  ...
  "builder.actions.create": "Create activity",
  ...
  "stats.description":
    "Participation counts remain derived from saved activity participants. Archived members remain in the history and can be filtered alongside the active roster.",
  ...
  "stats.filters.sortByCount": "Sort by count",
  ...
  "stats.table.participations": "Participations",
  "stats.table.empty": "No members match the current filters.",
  "history.badge": "Stats",
  "history.title": "{{name}} activity history",
  "history.description":
    "Review the saved Saturday activities that include {{name}}.",
  "history.stats.activities.title": "Participated activities",
  "history.stats.activities.description":
    "Saved activities containing this member",
...
export const koMessages: MessageDictionary = {
  "app.name": "Dessertrip",
  "app.metadata.description": "디저트 동아리 Dessertrip 운영 관리 앱입니다.",
  "theme.label": "테마",
  ...
  "nav.overview.description":
    "동아리 현황을 보고 주요 작업으로 바로 이동합니다.",
  "nav.members.label": "멤버",
  "nav.members.description":
    "멤버를 추가하고, 매니저 여부를 관리하고, 명단을 필터링합니다.",
  "nav.activities.label": "정기활동",
  "nav.activities.description":
    "정기활동을 조회하고 새 활동을 만들며 생성된 조를 관리합니다.",
  "nav.stats.label": "통계",
  "nav.stats.description":
  ...
  "dashboard.shell.navigationDescription":
    "공통 관리자 셸과 테마 설정을 유지한 채 대시보드 페이지를 이동합니다.",
  "dashboard.shell.signedIn": "로그인 중",
  "dashboard.shell.activeSessionOn": "{{page}} 페이지에서 매니저 세션이 활성화되어 있습니다",
  "dashboard.shell.page": "페이지",
  "dashboard.shell.navigationEnabled": "사이드바 내비게이션 사용 중",
  "overview.badge": "개요",
  "overview.title": "주간 디저트 동아리 운영 센터",
  "overview.description":
    "사이드바를 이용해 멤버, 정기활동, 통계 전용 페이지로 이동하세요.",
  "overview.stats.members.title": "멤버",
  "overview.stats.members.description": "명단에 매니저 {{count}}명",
  "overview.stats.activities.title": "정기활동",
  "overview.stats.activities.empty": "아직 저장된 정기활동이 없습니다",
  "overview.stats.activities.latest": "최근 활동: {{name}}",
  "overview.cta.open": "열기",
  "members.badge": "멤버",
  "members.title": "멤버 관리",
  "members.description":
    "이곳에서 멤버를 추가, 수정, 보관, 복원할 수 있습니다. 보관된 멤버는 기록에는 남고 기본 명단에서는 숨겨집니다.",
  "members.stats.all.title": "전체 멤버",
  "members.stats.all.description": "보관된 멤버 포함",
  "members.stats.active.title": "활성 멤버",
  "members.stats.active.description": "새 정기활동에 선택 가능",
  "members.stats.archived.title": "보관됨",
  "members.stats.archived.description": "이 페이지에서 복원 가능",
  "members.roster.title": "멤버 목록",
  "members.roster.summary":
    "현재 필터 기준 {{total}}명 중 {{visible}}명을 표시하고 있습니다.",
  ...
  "members.empty": "현재 필터와 일치하는 멤버가 없습니다.",
  ...
  "members.modal.create.description":
    "Dessertrip 명단에 새로운 멤버를 추가합니다.",
  "members.modal.edit.title": "멤버 수정",
  "members.modal.edit.description": "{{name}}의 명단 정보를 수정합니다.",
  "members.modal.archive.title": "멤버 보관",
  "members.modal.archive.description":
    "{{name}}은(는) 활성 명단에서는 사라지지만 기존 활동 기록과 참여 통계에는 유지됩니다.",
  "members.modal.name": "이름",
  "members.modal.namePlaceholder": "멤버 이름",
  "members.modal.gender": "성별",
  "members.modal.managerCheckbox": "이 멤버는 동아리 매니저입니다",
  ...
  "activities.badge": "정기활동",
  "activities.title": "정기활동 관리",
  "activities.description":
    "저장된 토요일 정기활동을 둘러보고, 생성된 조를 확인하고, 생성 또는 수정 화면으로 이동합니다.",
  "activities.stats.saved.title": "저장된 활동",
  "activities.stats.saved.description": "저장된 전체 토요일 기록",
  "activities.stats.visible.title": "표시 중",
  "activities.stats.visible.description": "현재 검색 결과",
  "activities.stats.openDetail.title": "열린 상세",
  "activities.stats.openDetail.description": "확장된 활동 패널",
  "activities.list.title": "저장된 정기활동",
  "activities.list.description":
    "이 페이지에서 지난 활동을 검색하거나 새 활동을 시작하세요.",
  "activities.list.add": "정기활동 추가",
  "activities.searchPlaceholder": "활동명 또는 지역으로 검색",
  "activities.empty": "현재 필터와 일치하는 정기활동이 없습니다.",
  "activities.collapse.hint": "조와 작업 보기",
  ...
  "activities.groups.empty": "저장된 조가 아직 없습니다.",
  "activities.group.title": "{{number}}조",
  "activities.badge.members": "멤버 {{count}}명",
  "activities.unknownMember": "알 수 없는 멤버",
  "builder.badge": "정기활동",
  "builder.title.add": "정기활동 추가",
  "builder.title.edit": "정기활동 수정",
  "builder.description":
    "날짜와 장소를 입력하고 멤버를 선택한 뒤 조를 생성하고 수동으로 조정할 수 있습니다.",
  ...
  "builder.stats.targetGroups.description": "매니저 우선 랜덤 편성 사용",
  "builder.stats.generatedGroups.title": "생성된 조",
  "builder.stats.generatedGroups.archived": "수정용 보관 멤버 {{count}}명 포함",
  "builder.stats.generatedGroups.editing": "기존 정기활동 수정 중",
  "builder.stats.generatedGroups.new": "새 활동 초안",
  "builder.form.title.add": "새 정기활동",
  "builder.form.title.edit": "정기활동 수정",
  "builder.form.description":
    "기본 정보를 먼저 입력하고, 멤버 선택 후 조를 생성하세요.",
  "builder.form.back": "정기활동 목록으로",
  "builder.field.date": "토요일 날짜",
  "builder.field.location": "장소",
  "builder.field.locationPlaceholder": "강남, 마포, 성수...",
  "builder.selected.title": "선택된 멤버",
  "builder.selected.description":
    "검색 가능한 전용 모달에서 참여 멤버를 선택하세요.",
  ...
  "builder.validation.requiredFields": "활동 날짜와 장소를 입력해야 합니다.",
  "builder.validation.noParticipantsSave":
    "저장하기 전에 최소 1명의 참여 멤버를 선택하세요.",
  "builder.validation.targetTooLarge":
    "조 개수는 선택된 참여 멤버 수보다 많을 수 없습니다.",
  "builder.validation.generateBeforeSave":
    "이 활동을 저장하기 전에 조를 생성하세요.",
  "builder.validation.noParticipantsGenerate":
    "조를 생성하기 전에 최소 1명의 참여 멤버를 선택하세요.",
  "builder.warning.managerShortage":
    "선택된 매니저 수보다 조 개수가 많아서 일부 조에는 매니저가 없을 수 있습니다.",
  "builder.adjust.title": "생성된 조 조정",
  "builder.adjust.description":
    "저장 전에 멤버를 다른 조로 드래그하거나 같은 조 안에서 순서를 바꿀 수 있습니다.",
  "builder.adjust.mobileHint":
    "모바일에서는 멤버를 길게 눌러 드래그한 뒤, 화면 위나 아래 가장자리로 이동해 스크롤하세요.",
  "builder.adjust.empty": "멤버 배치를 시작하려면 먼저 조를 생성하세요.",
  ...
  "stats.description":
    "참여 횟수는 저장된 활동 참여자를 기준으로 계산됩니다. 보관된 멤버도 이력에 유지되며 활성 명단과 함께 필터링할 수 있습니다.",
  "stats.stats.tracked.title": "집계 대상 멤버",
  "stats.stats.tracked.description": "참여 통계에 포함된 멤버",
  "stats.stats.visible.title": "표시 행 수",
  "stats.stats.visible.description": "필터 및 정렬 결과",
  "stats.stats.archived.title": "보관된 멤버",
  "stats.stats.archived.description": "이력 명단 유지",
  "stats.filters.searchPlaceholder": "통계 검색",
  "stats.filters.sortByCount": "참여 횟수순",
  ...
  "stats.table.role": "역할",
  "stats.table.participations": "참여 횟수",
  "stats.table.empty": "현재 필터와 일치하는 멤버가 없습니다.",
  "history.badge": "통계",
  "history.title": "{{name}} 활동 이력",
  "history.description": "{{name}}이(가) 포함된 저장된 토요일 활동을 확인합니다.",
  "history.stats.activities.title": "참여한 활동",
  "history.stats.activities.description": "이 멤버가 포함된 저장 활동",
  ...
  "history.section.description":
    "저장된 활동을 열어 생성된 조를 검토하거나 수정할 수 있습니다.",
  "history.section.back": "통계로 돌아가기",
  "history.empty": "이 멤버가 포함된 저장 활동이 아직 없습니다.",
  ...
  "errors.auth.invalidCredentials": "아이디 또는 비밀번호가 올바르지 않습니다.",
  "errors.member.notFound": "멤버를 찾을 수 없습니다.",
  "errors.activity.notFound": "정기활동을 찾을 수 없습니다.",
  "errors.validation.member.nameRequired": "이름은 필수입니다.",
  "errors.validation.member.genderRequired": "성별은 필수입니다.",
  "errors.validation.member.isManagerRequired":
    "isManager 값은 필수입니다.",
  "errors.validation.member.updateRequired":
    "최소 1개 이상의 멤버 정보를 수정해야 합니다.",
  "errors.validation.admin.usernameRequired": "아이디는 필수입니다.",
  "errors.validation.admin.passwordMin":
    "비밀번호는 8자 이상이어야 합니다.",
  "errors.validation.activity.dateFormat":
    "activityDate는 YYYY-MM-DD 형식이어야 합니다.",
  "errors.validation.activity.saturdayRequired":
    "activityDate는 KST 기준 토요일이어야 합니다.",
  "errors.validation.activity.areaRequired": "장소는 필수입니다.",
  "errors.validation.activity.updateRequired":
    "최소 1개 이상의 활동 정보를 수정해야 합니다.",
  "errors.validation.activity.participantsUnique":
    "participantMemberIds는 중복될 수 없습니다.",
  "errors.validation.activity.groupMemberRequired":
    "각 조에는 최소 1명의 멤버가 있어야 합니다.",
  "errors.validation.activity.groupMembersUnique":
    "한 조 안에서 멤버는 중복될 수 없습니다.",
  "errors.validation.activity.groupNumberRequired":
    "groupNumber는 필수입니다.",
  "errors.validation.activity.groupNumberInteger":
    "groupNumber는 정수여야 합니다.",
  "errors.validation.activity.groupNumberUnique":
    "groupNumber는 중복될 수 없습니다.",
  "errors.validation.activity.targetGroupRequired":
    "targetGroupCount는 필수입니다.",
  "errors.validation.activity.targetGroupInteger":
    "targetGroupCount는 정수여야 합니다.",
  "errors.validation.activity.groupedMembersSelectedOnly":
    "조에 포함된 멤버는 반드시 선택된 참여자여야 합니다.",
  "errors.validation.activity.memberInMultipleGroups":
    "한 멤버가 여러 조에 동시에 포함될 수 없습니다.",
  "errors.validation.activity.groupsMustCoverParticipants":
    "저장된 조는 선택된 모든 참여자를 정확히 한 번씩 포함해야 합니다.",
  "errors.validation.activity.groupGeneratedAtRequired":
    "조가 저장될 때는 groupGeneratedAt이 필요합니다.",
  "errors.validation.activity.groupGeneratedAtEmptyOnly":
    "조가 비어 있을 때는 groupGeneratedAt을 설정할 수 없습니다.",
  "errors.validation.activity.memberReference":
    "participantMemberId는 모두 존재하는 멤버를 가리켜야 합니다.",
  "errors.grouping.failedManagers": "매니저를 조에 배치하지 못했습니다.",
  "errors.grouping.failedMembers":
    "선택된 멤버로 조를 생성하지 못했습니다.",
  "errors.grouping.invalidTarget":
    "targetGroupCount는 1 이상의 정수여야 합니다.",
  "errors.grouping.targetTooLarge":
    "targetGroupCount는 선택된 참여 멤버 수보다 많을 수 없습니다.",
