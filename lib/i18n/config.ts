...
export const koMessages: MessageDictionary = {
  ...
  "nav.activities.label": "정기 활동",
  "nav.activities.description": "정기 활동 조회, 새 활동 생성, 조 관리",
  "nav.stats.label": "통계",
  "nav.stats.description": "멤버별 정기 활동 참여 횟수 확인",
  "login.hero.badge": "디저트립",
  "login.hero.title": "디저트립 관리 페이지",
  "login.hero.description": "관리자 계정으로 멤버, 정기 활동, 참여 기록 관리",
  ...
  "overview.description": "사이드바에서 멤버, 정기 활동, 통계 페이지 이동",
  "overview.stats.members.title": "멤버",
  "overview.stats.members.description": "운영진 {{count}}명",
  "overview.stats.activities.title": "정기 활동",
  "overview.stats.activities.empty": "저장된 정기 활동 없음",
  ...
  "activities.badge": "정기 활동",
  "activities.title": "정기 활동 관리",
  "activities.description":
    "저장된 토요일 정기 활동 확인, 생성된 조 확인, 새 활동 생성, 기존 활동 수정",
  "activities.stats.saved.title": "저장된 활동",
  "activities.stats.saved.description": "저장된 전체 토요일 활동 기록",
  ...
  "activities.list.title": "저장된 정기 활동",
  "activities.list.description": "지난 활동 검색 또는 새 활동 시작",
  "activities.list.add": "정기 활동 추가",
  "activities.searchPlaceholder": "활동명 또는 지역으로 검색",
  "activities.empty": "현재 필터와 일치하는 정기 활동 없음",
  "activities.collapse.hint": "조 편성과 작업 보기",
  ...
  "builder.badge": "정기 활동",
  "builder.title.add": "정기 활동 추가",
  "builder.title.edit": "정기 활동 수정",
  "builder.description": "날짜와 장소 입력, 멤버 선택, 조 생성과 수동 조정",
  ...
  "builder.form.title.add": "새 정기 활동",
  "builder.form.title.edit": "정기 활동 수정",
  "builder.form.description": "기본 정보 입력 후 참여 멤버 선택과 조 생성",
  "builder.form.back": "정기 활동 목록으로",
  ...
  "builder.actions.create": "정기 활동 생성",
  ...
  "stats.description":
    "저장된 활동 참여자 기준 참여 횟수 집계. 보관 멤버도 이력 유지, 활성 멤버와 함께 필터링 가능",
  ...
  "history.description": "저장된 토요일 활동 중 {{name}} 참여 기록",
  ...
  "history.section.description": "저장된 활동 열기, 생성된 조 검토 또는 수정",
